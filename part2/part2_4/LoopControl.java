...
public class LoopControl {
    public static void main(String[] args) {
        ...
        // ▼ ВАШ КОД ЗДЕСЬ ▼
        // 1)метки outer: и search: позволяют программе вернутся в определенную точку
        // для продолжения работы кода с этого места
        // 2)continue outer вовзращает действие программы к метке, а не к началу цикла
        // 3) результат сохранен в part2_4\Result.txt
        // ▲ КОНЕЦ ВАШЕГО КОДА ▲
    }
}
